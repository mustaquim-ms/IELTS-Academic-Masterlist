...
export default function ListeningSection2() {
    const audioUrl = "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3";
    const questions = [
        { id: 1, text: "The talk is mainly about the history of:" },
        { id: 2, text: "The original purpose of the building was:" },
        { id: 3, text: "The main challenge of the restoration project was:" },
        { id: 4, text: "The speaker mentions a new exhibition for:" },
        { id: 5, text: "Entry to the museum is free for:" },
    ];

    return (
        <>
            <Head>
                <title>Listening Section 2 | Determined IELTS</title>
            </Head>
            <Navbar />
            <MainLayout>
                <ContentSection>
                    ...
                    <ContentWrapper>
                        ...
                        <p>
                            **Instructions:** Listen to the monologue and answer the questions below. You will only hear the audio once.
                        </p>
