...
export default function ListeningSection4() {
    const audioUrl = "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3";
    const questions = [
        { id: 1, text: "The speaker is a lecturer in the field of:" },
        { id: 2, text: "The main topic of today's lecture is:" },
        { id: 3, text: "The speaker mentions a key study conducted in:" },
        { id: 4, text: "A primary challenge of the new theory is:" },
        { id: 5, text: "The students' assignment requires them to:" },
    ];

    return (
        <>
            <Head>
                <title>Listening Section 4 | Determined IELTS</title>
            </Head>
            <Navbar />
            <MainLayout>
                <ContentSection>
                    ...
                    <ContentWrapper>
                        ...
                        <p>
                            **Instructions:** Listen to the academic lecture and answer the questions below. You will only hear the audio once.
                        </p>
